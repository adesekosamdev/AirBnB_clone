...
class TestConsole(unittest.TestCase):
    ...
    def test_quit(self):
        """tests quit command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
            self.consol.onecmd("quit")
            self.assertEqual('', f.getvalue())

    def test_create(self):
        """Tests create command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_all(self):
        """Tests alternate all command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_show(self):
        """Tests alternate show command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_destroy(self):
        """Tests alternate destroy command inpout"""
        with patch('sys.stdout', new=StringIO()) as f:
